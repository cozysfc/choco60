...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    ...
    KC_LALT,   KC_LGUI, KC_SPACE,                               KC_FN,    KC_BSPACE, KC_RGUI, KC_RALT
  ),
  [_FN] = LAYOUT(
    _______,   KC_F1,   KC_F2,    KC_F3,     KC_F4,   KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,    KC_F11,      KC_F12,      KC_INSERT, KC_BSPACE,
    _______,   XXXXXXX, XXXXXXX,  XXXXXXX,   XXXXXXX, XXXXXXX,  XXXXXXX,  KC_PGUP,  XXXXXXX,  XXXXXXX,  XXXXXXX,   XXXXXXX,     XXXXXXX,     XXXXXXX,
    _______,   XXXXXXX, XXXXXXX,  KC_PGDOWN, KC_END,  KC_HOME,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, XXXXXXX,   XXXXXXX,     _______,
